...
export interface ConsiderationInterface extends BaseContract {
  ...
  fulfillOrder: TypedContractMethod<
    [order: OrderStruct, fulfillerConduitKey: BytesLike],
    [boolean],
    "payable"
  >;
  ...
  matchOrders: TypedContractMethod<
    [orders: OrderStruct[], fulfillments: FulfillmentStruct[]],
    [ExecutionStructOutput[]],
    "payable"
  >;
  ...
  ): TypedContractMethod<[order: OrderComponentsStruct], [string], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[orders: OrderStruct[]], [boolean], "nonpayable">;
