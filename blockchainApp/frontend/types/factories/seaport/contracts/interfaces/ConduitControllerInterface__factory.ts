...
} from "../../../../seaport/contracts/interfaces/ConduitControllerInterface";
...
export class ConduitControllerInterface__factory {
  ...
  static createInterface(): ConduitControllerInterfaceInterface {
    return new Interface(_abi) as ConduitControllerInterfaceInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ConduitControllerInterface;
  }
}
