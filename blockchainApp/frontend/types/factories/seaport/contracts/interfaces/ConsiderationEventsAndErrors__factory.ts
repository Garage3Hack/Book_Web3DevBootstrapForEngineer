...
} from "../../../../seaport/contracts/interfaces/ConsiderationEventsAndErrors";
...
export class ConsiderationEventsAndErrors__factory {
  ...
  static createInterface(): ConsiderationEventsAndErrorsInterface {
    return new Interface(_abi) as ConsiderationEventsAndErrorsInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ConsiderationEventsAndErrors;
  }
}
