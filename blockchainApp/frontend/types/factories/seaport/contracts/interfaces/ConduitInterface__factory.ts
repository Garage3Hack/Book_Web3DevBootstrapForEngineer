...
} from "../../../../seaport/contracts/interfaces/ConduitInterface";
...
export class ConduitInterface__factory {
  ...
  static createInterface(): ConduitInterfaceInterface {
    return new Interface(_abi) as ConduitInterfaceInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ConduitInterface {
    return new Contract(address, _abi, runner) as unknown as ConduitInterface;
  }
}
